...
\begin{itemize}
  \item \textbf{Torticollis:} Condition that causes the head to tilt and turn to one side. 
  \item \textbf{Figure:} Positive space, foreground, main focus.
  \item \textbf{Ground:} Negative space, background, secondary focus.
  \item \textbf{Cursively Drawable:} Figure whose ground is an accident.
  \item \textbf{Recursive Figure:} Figure whose figure and ground and drawn cursively.
  \item \textbf{Monotonicity:} (In logic) A system where adding premises never invalidates a previous conclusion.
\end{itemize}
%===============================================
